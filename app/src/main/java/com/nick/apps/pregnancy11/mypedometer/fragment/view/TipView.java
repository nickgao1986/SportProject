...
public class TipView extends FrameLayout {
    ...
    public void setTipViewGravity(int gravity, int left, int top, int right, int bottom) {
        FrameLayout.LayoutParams params = (FrameLayout.LayoutParams) mBobyLayout.getLayoutParams();
        params.setMargins(ScreenUtil.dip2px(getContext(), left), ScreenUtil.dip2px(getContext(), top), ScreenUtil.dip2px(getContext(), right) ,ScreenUtil.dip2px(getContext(), bottom));
        mBobyLayout.setLayoutParams(params);
        mBobyLayout.setGravity(gravity);
    }
}
