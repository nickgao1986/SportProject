...
public class PedoPraiseButton extends RelativeLayout {
    ...
    public PedoPraiseButton(Context context) {
        super(context);
        init(context);
    }

    public PedoPraiseButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        animationHeight = ScreenUtil.dip2px(context, 55);
        ...
        View contentView = LayoutInflater.from(mContext).inflate(R.layout.pedo_praise_button, this);
