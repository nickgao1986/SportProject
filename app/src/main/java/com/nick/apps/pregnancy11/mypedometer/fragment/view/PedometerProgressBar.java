...
public class PedometerProgressBar extends View {
    ...
    public PedometerProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }

    public PedometerProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void drawArcRed(Canvas canvas, RectF rectF) {
        ...
        paintCurrent.setColor(getResources().getColor(R.color.color_24C789));//设置画笔颜色
    ...
    private void drawTextNumber(Canvas canvas, float centerX) {
        ...
        vTextPaint.setColor(getResources().getColor(R.color.color_24C789));
        Rect bounds_Number = new Rect();
        vTextPaint.setTypeface(Typeface.createFromAsset(mContext.getAssets(), "fonts/PingFang-SC-Semibold.ttf"));
